...
export default function Empty() {
  ...
  return (
    <div className="grow flex flex-col items-center justify-center gap-1 px-8">
      <span
        className={cn(
          "text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium tracking-tighter",
          {
      ...
      <span className="text-neutral-400 font-light opacity-70 dark:text-neutral-500 text-center text-xs md:text-sm">
      ...
      >
        <path
          ...
          className="fill-purple-100 dark:fill-purple-950"
        />
        <path
          ...
          className="stroke-purple-800 dark:stroke-purple-700 fill-purple-100 dark:fill-purple-950"
          strokeWidth="2.5"
        />
        <path
          fillRule="evenodd"
        ...
        <path
          d="M115.132 125.494C116.891 125.819 118.68 125.987 120.5 126C135.136 126 147 114.136 147 99.5C147 84.8645 135.136 73 120.5 73C116.74 73 113.164 73.7829 109.924 75.1946C104.294 77.6479 99.6816 81.9999 96.896 87.4419C95.0445 91.0589 94 95.1575 94 99.5C94 103.44 94.8599 107.179 96.4021 110.54C97.5032 112.94 98.9521 115.146 100.684 117.096"
          className="stroke-purple-800 dark:stroke-purple-700"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
        <path
        ...
        <path
          ...
          className="stroke-purple-800 dark:stroke-purple-700 fill-purple-400 dark:fill-purple-600"
          strokeWidth="2.5"
        />
        <path
          d="M158 133L169 144"
